    ...
    */
    ...
    class debug extends Controller
    {
        ...
        function export()
        {
            ...
            flush();
            $this->_fileReplace();
            echo '替换成功！<br/><h3>初始化默认用户数据...</h3><hr/>';
            flush();
            $this->_initUser();
            echo '初始化默认用户成功!<br/><h3>打包程序</h3><hr/>';
            flush();
        ...
        function _less()
        {
            ...
            $num = count($app_theme) * count($app_less);
            $i = 1;
        ...
        {
            mk_dir($this->path_to);
            echo '<br/>新建文件夹成功，开始复制文件';
            flush();
            copy_dir($this->path_app, $this->path_to);
            echo '<br/>复制文件成功，开始清除调试相关信息<hr/>';
            flush();
