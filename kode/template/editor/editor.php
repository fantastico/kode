...
<head>
    ...
    <link href="<?php echo STATIC_PATH; ?>style/skin/<?php echo $config['user']['theme']; ?>app_editor.css"
          rel="stylesheet" id='link_css_list'/>
    <?php }else{ //less_compare_online ?>
    <link rel="stylesheet/less" type="text/css"
          href="<?php echo STATIC_PATH; ?>style/skin/<?php echo $config['user']['theme']; ?>app_editor.less"/>
...
<div class="frame-main">
    ...
    <div class='frame-right'>
        <div class="frame-right-main" style="height:100%;padding:0;margin:0;">
            ...
            <div class='frame'>
                <iframe name="OpenopenEditor" src="./index.php?editor/edit" style="width:100%;height:100%;border:0;"
