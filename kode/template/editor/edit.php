...
<meta name="author" content="kalcaddle.">
  ...
  <body>
	<div class="edit_main" style="height: 100%;" oncontextmenu="return core.contextmenu();">
		<div class="tools">
			<div class="left">
				<a action="save" href="javascript:;" title='<?php echo $L['button_save'];?>
    (Ctrl-S)'><i class="font-icon icon-save"></i></a>
				<a action="saveall" href="javascript:;" title='<?php echo $L['button_save_all'];?>
    '><i class="font-icon icon-paste"></i></a>
				<span class="line"></span>
				<a action="pre" href="javascript:;" title="<?php echo $L['undo'];?>(Ctrl-Z)
    "><i class="font-icon icon-undo"></i></a>
				<a action="next" href="javascript:;" title="<?php echo $L['redo'];?>(Ctrl-Y)
    "><i class="font-icon icon-repeat"></i></a>
				<span class="line"></span>
				<a action="find" href="javascript:;" title="<?php echo $L['search'];?>(Ctrl-F)
    "><i class="font-icon icon-search"></i></a>
				<a action="gotoline" href="javascript:;" title="<?php echo $L['gotoline'];?>(Ctrl-L)
    "><i class="font-icon icon-pushpin"></i></a>
				<span class="line"></span>
				<a action="font" class="font" data-toggle="dropdown" href="javascript:;
    " title="<?php echo $L['font_size'];?>" id='drop_fontsize'>
					<i class="font-icon icon-font"></i><i class="font-icon icon-caret-down"></i>
				</a>
				<a action="codetheme" class="codetheme" data-toggle="dropdown" href="javascript:;
    " title="<?php echo $L['code_theme'];?>" id='drop_codetheme'>
					<i class="font-icon icon-magic"></i><i class="font-icon icon-caret-down"></i>
				</a>
				<span class="line"></span>
				<a action="wordbreak" href="javascript:;" title="<?php echo $L['wordwrap'];?>
    "><i class="font-icon icon-level-down"></i></a>
				<a action="display" href="javascript:;" title="<?php echo $L['char_all_display'];?>
    "><i class="font-icon icon-eye-open"></i></a>
				<a action="auto_complete" class="select" href="javascript:;" title="<?php echo $L['auto_complete'];?>
    "><i class="font-icon icon-code"></i></a>
				<span class="line"></span>
				<a action="setting" href="javascript:;" title="<?php echo $L['setting'];?>"><i class="font-icon icon-cog"></i></a>
				<a action="preview" href="javascript:;" title="<?php echo $L['preview'];?>(Ctrl-Shift-S)
    "><i class="font-icon icon-globe"></i></a>
			</div>
			<div class="right">
				<a action="max" href="javascript:;" title="<?php echo $L['full_screen'];?>
    "><i class="font-icon icon-fullscreen"></i></a>
