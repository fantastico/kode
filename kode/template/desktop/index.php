...
<head>
    ...
    <link href="<?php echo STATIC_PATH; ?>style/skin/<?php echo $config['user']['theme']; ?>app_desktop.css"
          rel="stylesheet" id='link_css_list'/>
    <?php }else{ //less_compare_online ?>
    <link rel="stylesheet/less" type="text/css"
          href="<?php echo STATIC_PATH; ?>style/skin/<?php echo $config['user']['theme']; ?>app_desktop.less"/>
...
<div class='bodymain html5_drag_upload_box desktop'>
    <div class="fileContiner fileList_icon">
        <div class="file systemBox menuDefault"
             data-app='{"name":"","resize":1,"type":"app","width":"800","height":"500","content":"core.explorer();"}'>
            <div class="ico" filetype="oexe"
                 style="background-image:url(<?php echo STATIC_PATH; ?>images/app/computer.png)"></div>
        ...
        <div class="file systemBox menuDefault" title="<?php echo $L['setting']; ?>"
            ...
            <div class="ico" filetype="oexe"
                 style="background-image:url(<?php echo STATIC_PATH; ?>images/app/setting.png)"></div>
        ...
        <div class="file systemBox menuDefault" title="<?php echo $L['app_store']; ?>"
            ...
            <div class="ico" filetype="oexe"
                 style="background-image:url(<?php echo STATIC_PATH; ?>images/app/market.png)"></div>
...
<div id="menuwin">
    ...
    <ul id="programs">
        <li><a href="#" onclick="ui.pathOpen.openIE('http://www.kalcaddle.com','<?php echo $L['my_document']; ?>');">kodexplorer-home</a>
        </li>
        <li>
    ...
    <ul id="links">
        <li class="icon"></li>
        <li><a href="#"
               onclick="core.explorer('<?php echo MYHOME; ?>/document','<?php echo $L['my_document']; ?>');"><span><?php echo $L['my_document']; ?></span></a>
        </li>
        <li><a href="#"
               onclick="core.explorer('<?php echo MYHOME; ?>/picture','<?php echo $L['my_picture']; ?>');"><span><?php echo $L['my_picture']; ?></span></a>
        </li>
        <li><a href="#"
               onclick="core.explorer('<?php echo MYHOME; ?>/music','<?php echo $L['my_music']; ?>');"><span><?php echo $L['my_music']; ?></span></a>
        </li>
        <li><a href="#"
               onclick="core.explorer('<?php echo MYHOME; ?>/download','<?php echo $L['download']; ?>');"><span><?php echo $L['download']; ?></span></a>
        </li>
        <li>
        ...
        <li><a href="./index.php?user/logout" style="margin-top:70px;"><span><?php echo $L['ui_logout']; ?>></span></a>
        </li>
    </ul>
</div>
