...
<div class="section group_editor hidden">
    <div class="together input">
        ...
        <a href="javascript:;" class="button warning"
           style="margin-left: 20px;padding: 3px 5px;background: #ccc;border:none;color:#fff;"><i
                class="icon-warning-sign"></i><?php echo $L['tips']; ?>!</a>
        ...
        <a href="javascript:;" class="button warning path_ext_tips" title='<?php echo $L['group_role_ext_warning']; ?>'
           style="margin-left: 20px;padding: 3px 5px;background: #ccc;border:none;color:#fff;"><i
                class="icon-warning-sign"></i><?php echo $L['tips']; ?>!</a>
