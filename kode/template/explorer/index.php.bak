...
<head>
    ...
    <link href="<?php echo STATIC_PATH; ?>style/skin/<?php echo $config['user']['theme']; ?>app_explorer.css"
          rel="stylesheet" id='link_css_list'/>
    <?php }else{ //less_compare_online ?>
    <link rel="stylesheet/less" type="text/css"
          href="<?php echo STATIC_PATH; ?>style/skin/<?php echo $config['user']['theme']; ?>app_explorer.less"/>
    ...
    <div class="header-content">
        <div class="header-left">
            <div class="btn-group btn-group-sm">
                <button class="btn btn-default" id='history_back' title='<?php echo $L['history_back']; ?>'
                        type="button">
                    <i class="font-icon icon-arrow-left"></i>
                </button>
                <button class="btn btn-default" id='history_next' title='<?php echo $L['history_next']; ?>'
                        type="button">
        ...
        <div class="frame-right-main">
            <div class="tools">
                ...
                <div class="tools-right">
                    <div class="btn-group btn-group-sm">
                        <button id='set_apk' title="<?php echo $L['list_apk']; ?>" type="button"
                        ...
                        <div class="btn-group btn-group-sm">
                            <button id="set_theme" title="<?php echo $L['setting_theme']; ?>" type="button"
