...
define(function (require, exports) {
    ...
    return {
        ...
        appList: function () {
            pathOperate.appList(_param().path);
        },
        appInstall: function () {
            pathOperate.appInstall(_param().path);
        },

        //open
        openEditor: function () {
            pathOpen.openEditor(_param().path);
        },
        openIE: function () {
            pathOpen.openIE(_param().path);
        },
        download: function () {
        ...
        search: function () {
            core.search('', _param().path);
        },
        fav: function () {
            pathOperate.fav(_param().path);
        },
        remove: function () {
            pathOperate.remove(_param(true), refreshCallback);
            fileLight.clear();
        },
        copy: function () {
            pathOperate.copy(_param(true));
        },
        cute: function () {
            pathOperate.cute(_param(true), ui.f5);
        },
        zip: function () {
            pathOperate.zip(_param(true), refreshCallback);
        },
        unZip: function () {
            pathOperate.unZip(_param().path, ui.f5);
        },
        cuteDrag: function (dragTo) {
            pathOperate.cuteDrag(_param(true), dragTo, refreshCallback);
        },
